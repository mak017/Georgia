class PauseButton {
    ...
    draw(gr) {
        ...
        gr.FillRoundRect(this.left, this.top, geo.pause_size, geo.pause_size, 0.1 * geo.pause_size, 0.1 * geo.pause_size, rgba(0, 0, 0, 150));
        gr.DrawRoundRect(
            this.left + halfBorderWidth,
            this.top + halfBorderWidth,
        ...
        gr.FillRoundRect(
            this.left + 0.26 * geo.pause_size,
            this.top + 0.25 * geo.pause_size,
            0.12 * geo.pause_size,
            0.5 * geo.pause_size,
            2,
            2,
        ...
        if (pref.show_progress_bar) {
            ...
            if (fb.PlaybackLength) {
                ...
                if (progressStationary && fb.IsPlaying && !fb.IsPaused) {
                    ...
                    gr.DrawLine(
                        this.progressLength + this.x + 1,
                        this.y,
                        this.progressLength + this.x + 1,
                        this.y + this.h - 1,
                        1,
                        this.progressAlphaCol
                    );
                }
            }
        }
